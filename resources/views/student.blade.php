...
@section('content')
        ...
        <form action="/search/student" class="w-80 md:w-96 mx-auto mt-4" method="GET">
            @csrf
            <div class="my-3">
                <label for="email" class="font-bold block mb-1">Matric Number</label>
                <input type="text" placeholder="Enter Matric Number here" name="matric_no" class="block outline-none py-3 px-2 w-full bg-white shadow-md rounded-md" id="">
            </div>
